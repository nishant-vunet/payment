...
type Service interface {
    Authorise(total float32, traceID string,spanID string) (Authorisation, error) // GET /paymentAuth
...
func (s *service) Authorise(amount float32, traceID string,spanID string) (Authorisation, error) {
